  ...
  return (
    <nav
      ...
      style={{
        ...
        boxShadow: "0 2px 8px rgba(54,116,181,0.08)",
      }}
    >
      <div className="container-fluid">
        ...
        >
          <FaProjectDiagram style={{ marginRight: 8, fontSize: 24 }} />{" "}
          ProManage
        </Link>
        <button
        ...
        <div className="collapse navbar-collapse" id="employeeNavbar">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <Link
                ...
                style={{ color: "#fff", fontWeight: 500 }}
              >
                <FaClipboardList style={{ marginRight: 4 }} /> My Projects
              </Link>
            </li>
            <li className="nav-item">
              <Link
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            >
              ...
              <span style={{ fontSize: "1rem" }}>{user?.sub || "Employee"}</span>
            </Link>
            <button
